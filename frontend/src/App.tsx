...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-dark via-background-dark to-accent-red">
      <Header activeSection={activeSection} onSectionChange={setActiveSection} />
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {renderSection()}
      </main>
      <footer className="bg-background-card border-t border-primary-light mt-12">
